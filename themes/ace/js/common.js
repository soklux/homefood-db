...
window.location = BASE_URL + '/index.php/site/logout';
});


$(window).jkey('f2',function(){
window.location = BASE_URL + '/index.php/saleItem/index';
});

/*
$(window).jkey('f4',function(){
window.location = BASE_URL + '/index.php/saleItem/AddPayment';
});

$(window).jkey('f4',function(){
window.location = BASE_URL + '/index.php/suppliers/index';
});

$(window).jkey('f5',function(){
window.location = BASE_URL + '/index.php/receivings/index';
});
