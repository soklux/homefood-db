                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="dl-horizontal pull-right">
                            <dt><?php echo Yii::t('app','Total'); ?> :</dt><dd><span class="label label-info"><?php echo '$'.number_format($total,Common::getDecimalPlace(), '.', ','); ?></span></dd>
                            <dt><?php echo Yii::t('app','Amount Due'); ?>:</dt><dd><span class="label label-important"><?php echo '$'.number_format($amount_due,Common::getDecimalPlace(), '.', ',');  ?></span></dd>
                        </div>
...
<div class="col-xs-7" id="product_show"> 
            ...
            <div class="slider1">
               <!-- Product Categories -->
                   ...
                   <a href="<?php echo Yii::app()->createUrl("saleItem/index",array("category_id"=>$category->id)); ?>" title="<?php echo $category->name; ?>" class="list-item">
                      <?php echo TbHtml::imagePolaroid('holder.js/260x90/ace/text:' . ucfirst($category->name),$category->name); ?>
                   </a>
                   </div>
                   <?php } ?>
                   <div class="slide">
                   <a href="<?php echo Yii::app()->createUrl("saleItem/index",array("category_id"=>-1)); ?>" title="Other">
                       <?php echo TbHtml::imagePolaroid('holder.js/250x96/ace/text:Other'); ?>
                   </a>
                   </div>
               <!-- //Product Categories  -->
             </div> 
    ...
    <div class="produc-list slim-scroll" data-height="400">
        <ul class="ace-thumbnails clearfix">
            ...
            <li>
                <a href="<?php echo Yii::app()->createUrl("saleItem/indexpara",array("item_id"=>$product->id)); ?>" title="<?php echo $product->name; ?>" data-rel="colorbox" class="list-product">
                    <?php  echo TbHtml::imagePolaroid('holder.js/110x100/acename/text:');
                        /*
                        if ($item_image) { 
                    ...
                    <div class="tags">
                        <span class="label-holder">
                            <span class="label label-info"><?php echo TbHtml::encode($product->name); ?></span>
                        </span>
                         <span class="label-holder">
                            <span class="label label-success arrowed-in"><?php echo number_format($product->unit_price,Common::getDecimalPlace()); ?></span>
                         </span>
                    </div>
                </a>
            </li>
...
<script type="text/javascript">
    ...
    Holder.add_theme("ace", {background:"#438EB9", foreground:"#FFFFFF",size:28, font: "Open Sans",}) 
    Holder.add_theme("acename", {background:"#fff", foreground:"#FFFFFF",size:0, font: "Open Sans",})
</script>