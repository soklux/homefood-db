...
<?php $this->widget('EExcelView',array(
	...
	'template'=>"{summary}\n{items}\n{exportbuttons}\n{pager}",
		...
		array('name'=>'sub_total',
                      ...
                      'footer'=>Yii::app()->settings->get('site', 'currencySymbol') . number_format($report->saleDailyTotals()[1],Common::getDecimalPlace(), ".", ","),
                      'footerHtmlOptions'=>array('style' => 'text-align: right;'),
                ),
                array('name'=>'discount',
                      ...
                      'footer'=>Yii::app()->settings->get('site', 'currencySymbol') . number_format($report->saleDailyTotals()[2],Common::getDecimalPlace(), ".", ","),
                      'footerHtmlOptions'=>array('style' => 'text-align: right;'),
                ),
                array('name'=>'total',
