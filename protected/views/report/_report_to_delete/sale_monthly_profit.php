...
<?php $this->widget('yiiwheels.widgets.grid.WhGridView',array(
	...
	'columns'=>array(
		array('name'=>'YM',
                      'header'=>Yii::t('app','Month Year'), 
                      'value'=>'$data["date_report"]',
                ),
                array('name'=>'sub_total',
                      'header'=>Yii::t('app','Sub Total'),
                      'value' =>'Yii::app()->numberFormatter->formatCurrency($data["sub_total"],"")',
                      'htmlOptions'=>array('style' => 'text-align: right;'),
                      'headerHtmlOptions'=>array('style' => 'text-align: right;'),
                      'footer'=>Yii::app()->settings->get('site', 'currencySymbol') . number_format($report->saleMonthlyProfitTotalAmount(),Common::getDecimalPlace(), ".", ","),
		...
		array('name'=>'profit',
                      ...
                      'footer'=>Yii::app()->settings->get('site', 'currencySymbol') . number_format($report->saleMonthlyProfitTotalProfit(),Common::getDecimalPlace(), ".", ","),
                      'footerHtmlOptions'=>array('style' => 'text-align: right;'),
                ),
                array('name'=>'margin',
