<div class="row">
    <div class="col-xs-12">
        <table class="table" id="receipt_items">
            <thead>
            <tr>
                <th><?= 'ល.រ' . "<br>" . Yii::t('app','NO.'); ?></th>
                <th><?= 'បរិយាយមុខទំនិញ' . "<br>" . Yii::t('app','Description'); ?></th>
                <th class="center" >
                    <?= 'បរិមាណ' . "<br>" . TbHtml::encode(Yii::t('app','QTY')) ?>
                </th>
                <th class="center" >
                    <?= '' . "<br>" . TbHtml::encode(Yii::t('app','UOM')); ?>
                </th>
                <th class="center">
                    <?= 'ថ្លៃងកតា' . "<br>" . Yii::t('app','UNIT PRICE'); ?>
                </th>
                <th class="<?= 'center' . ' ' . Yii::app()->settings->get('sale','discount'); ?>">
                    <?= TbHtml::encode(Yii::t('app','Discount')); ?>
                </th>
                <th class="text-right">
                    <?= 'ថ្លៃទំនិញ' . "<br>" . TbHtml::encode(Yii::t('app','AMOUNT')); ?>
                </th>
            </tr>
            </thead>
            <tbody>
