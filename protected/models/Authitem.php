...
class Authitem extends CActiveRecord
{
    ...
    public function getAuthItemReport($match = 'report.index')
    {
        $match = addcslashes($match, '%_'); // escape LIKE's special characters
    ...
    public function getAuthItemReportProfit($match = 'report.profit')
    {
        $match = addcslashes($match, '%_'); // escape LIKE's special characters
    ...
    public function getAuthItem($match = 'category')
    {
        $match = addcslashes($match, '%_'); // escape LIKE's special characters
    ...
    public function getAuthItemDataList($match = 'item')
    {
        $match = addcslashes($match, '%_'); // escape LIKE's special characters
    ...
    public function getRoleName()
    {
        ...
        $list = CHtml::listData($model, 'name', 'RoleInfo');
