<?php
/*
 * Calendar is a calendar based on the Collest DHTML Calendar -
...
class Calendar extends CWidget {
  ...
  /* @var $onSelect String */
  private $_onSelect=' function() { this.hide() }';
  /* @var $onClose String */
  private $_onClose;
  /* @var $onUpdate String */
  private $_onUpdate;
...
/*** * @param integer $step */
  ...
  // Get the resources path
    ...
    //If stylesheet
    if(isset($this->_stylesheet) && $this->_stylesheet!= "") {
      if(is_file($resources.'/css/'.$this->_stylesheet. '/' .$this->_stylesheet.'.css')) {
        Yii::app()->clientScript->registerCssFile($baseUrl.'/css/'.$this->_stylesheet. '/'. $this->_stylesheet.'.css');
      }
    } 
