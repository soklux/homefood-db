<?php
	...
	* @version 0.3
	*/	
	class EExcelView extends WhGridView
	{
		//Document properties
		...
		public $exportButtons = array('Excel2007','PDF');
		...
		public function init()
		{
			...
			{			
				...
				// Thanks here :) http://www.yiiframework.com/forum/index.php/topic/63334-eexcelview-extentions-with-pdf-library/
				$rendererName = PHPExcel_Settings::PDF_RENDERER_MPDF;
				$rendererLibraryPath = Yii::app()->basePath . '/vendor/mpdf';
				...
				// End block add from Thanks above
