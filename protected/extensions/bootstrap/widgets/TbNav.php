...
class TbNav extends CWidget
{
    ...
    public $submenuHtmlOptions = array(); //Added submenu option for <ul> tag formatting
    ...
    public function run()
    {
        if (!empty($this->items)) {
            ...
            echo TbHtml::nav($this->type, $this->items, $this->htmlOptions, $this->submenuHtmlOptions); //add submenuHtmlOptions parameter
        }
    }
